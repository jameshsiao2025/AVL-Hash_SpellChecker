...
TEST(AVLSet_SanityCheckTests, containsElementsAfterAddingMany)
{
    AVLSet<int> s1;
    s1.add(1);
    s1.add(2);
    ...
    EXPECT_TRUE(s1.contains(45));
    EXPECT_TRUE(s1.contains(38));
    EXPECT_TRUE(s1.contains(92));
    EXPECT_TRUE(s1.contains(10000));

    EXPECT_TRUE(s1.contains(6));
    // EXPECT_TRUE(s1.contains(7));
    // EXPECT_TRUE(s1.contains(8));
    // EXPECT_TRUE(s1.contains(9));
